        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Categories>(entity =>
            {
                ...
                entity.HasIndex(e => e.Rowguid)
                    .HasName("MSmerge_index_2041058307")
                    .IsUnique();
            ...
            modelBuilder.Entity<CustomerCustomerDemo>(entity =>
            {
                ...
                entity.HasIndex(e => e.Rowguid)
                    .HasName("MSmerge_index_853578079")
                    .IsUnique();
            ...
            modelBuilder.Entity<Customers>(entity =>
            {
                ...
                entity.HasIndex(e => e.Rowguid)
                    .HasName("MSmerge_index_2073058421")
                    .IsUnique();
            ...
            modelBuilder.Entity<EmployeeTerritories>(entity =>
            {
                ...
                entity.HasIndex(e => e.Rowguid)
                    .HasName("MSmerge_index_917578307")
                    .IsUnique();
            ...
            modelBuilder.Entity<Employees>(entity =>
            {
                ...
                entity.HasIndex(e => e.Rowguid)
                    .HasName("MSmerge_index_1977058079")
                    .IsUnique();
            ...
            modelBuilder.Entity<OrderDetails>(entity =>
            {
                ...
                entity.HasIndex(e => e.Rowguid)
                    .HasName("MSmerge_index_325576198")
                    .IsUnique();
            ...
            modelBuilder.Entity<Orders>(entity =>
            {
                ...
                entity.HasIndex(e => e.Rowguid)
                    .HasName("MSmerge_index_21575115")
                    .IsUnique();
            ...
            modelBuilder.Entity<Products>(entity =>
            {
                ...
                entity.HasIndex(e => e.Rowguid)
                    .HasName("MSmerge_index_117575457")
                    .IsUnique();
            ...
            modelBuilder.Entity<Region>(entity =>
            {
                ...
                entity.HasIndex(e => e.Rowguid)
                    .HasName("MSmerge_index_885578193")
                    .IsUnique();
            ...
            modelBuilder.Entity<Shippers>(entity =>
            {
                ...
                entity.HasIndex(e => e.Rowguid)
                    .HasName("MSmerge_index_2105058535")
                    .IsUnique();
            ...
            modelBuilder.Entity<Suppliers>(entity =>
            {
                ...
                entity.HasIndex(e => e.Rowguid)
                    .HasName("MSmerge_index_2137058649")
                    .IsUnique();
            ...
            modelBuilder.Entity<Sysdiagrams>(entity =>
            {
                entity.HasKey(e => e.DiagramId)
                    .HasName("PK__sysdiagrams__48CFD27E");

                entity.ToTable("sysdiagrams");

                entity.HasIndex(e => e.Rowguid)
                    .HasName("MSmerge_index_1205579333")
                    .IsUnique();
